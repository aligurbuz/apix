...
class consoleColors {
    ...
    public function info($string, $foreground_color = 'blue', $background_color = 'white') {
        ...
        return '' . PHP_EOL.''.$colored_string.'' . PHP_EOL;
    }
    ...
    // Returns colored string information
    public function warning($string, $foreground_color = 'white', $background_color = 'magenta') {
        $colored_string = "";
    ...
    // Returns colored string information
    public function done($string, $foreground_color = 'white', $background_color = 'yellow') {
        $colored_string = "";
